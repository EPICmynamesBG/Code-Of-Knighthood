...
public class Text2Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setText();
        return (ScrollView)inflater.inflate(R.layout.text2_activity, container, false);
    }
    ...
    private void setText(){
		...
		TextView text1_1=(TextView) getView().findViewById(R.id.text2_1);
		TextView text1_2=(TextView) getView().findViewById(R.id.text2_2);
		TextView text1_3=(TextView) getView().findViewById(R.id.text2_3);
